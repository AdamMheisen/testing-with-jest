...
test('The page should show the stack size after pushing an element', async () => {
    await driver.get(fileUnderTest);
    ...
    let alert = await driver.switchTo().alert();
    await alert.sendKeys("Melon");
    await alert.accept();

    let size = await driver.findElement(By.id('stack_size')).getText();
